...
public interface DAOIfs<T> {
	...
	int insert(T dto); // insert into bus_company (c_code, c_name, c_address, c_telno) values ('1','나성민', '월평동 1234','01084819654')
	int update(T dto); // update bus_company set c_name='홍길동' where c_code = ?;
